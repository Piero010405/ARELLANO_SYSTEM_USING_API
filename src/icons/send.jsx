...
const SVGComponent = ({size = 20, color = "currentColor", ...props}) => (
  ...
  >
    ...
    <path d="M52.232 43.67a1.006 1.006 0 0 0-1.221.717l-.103.393a1.002 1.002 0 0 0 1.937.505l.103-.394a1.002 1.002 0 0 0-.716-1.221zM51.479 46.572a1 1 0 0 0-1.22.717l-2.132 8.209a1 1 0 1 0 1.936.502l2.133-8.209a1.001 1.001 0 0 0-.717-1.219z" fill={color}/>
  </svg>
);
